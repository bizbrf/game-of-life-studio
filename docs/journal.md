...
- 2026-04-14 — Landed Batch 3a from [docs/review/REVIEW.md](review/REVIEW.md) on `fix/batch-3a-perf-caching`: performance caching pass (the low-risk half of Batch 3; the batching/bucketing refactor is Batch 3b). 3 atomic commits.
